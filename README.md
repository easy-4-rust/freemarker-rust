...
[Boundaries](#boundaries) and the security model in [`docs/release/security.md`](docs/release/security.md).
...
[`docs/02-架构设计.md`](docs/02-架构设计.md) and
...
| 183 built-ins (`?api`, `?has_api`, `?new`, `?lower_abc`, `?eval_json`, …) | Implemented | `compatibility` matrix in `docs/05-内建函数迁移清单.md` |
...
- [`docs/测试/迁移测试对照表.md`](docs/测试/迁移测试对照表.md) — 128 fixture dispositions
- [`docs/05-内建函数迁移清单.md`](docs/05-内建函数迁移清单.md) — 183 built-in parity
- [`docs/release/security.md`](docs/release/security.md) — restricted subset, 15 permanent NA
...
[`docs/测试/生产就绪审计.md`](docs/测试/生产就绪审计.md). The compatibility report
...
|:---|:---|:---|
| Architecture | [`docs/02-架构设计.md`](docs/02-架构设计.md) | 同左 |
| Parser | [`docs/03-解析器迁移设计.md`](docs/03-解析器迁移设计.md) | 同左 |
| Renderer | [`docs/04-渲染引擎与指令迁移设计.md`](docs/04-渲染引擎与指令迁移设计.md) | 同左 |
| Built-ins | [`docs/05-内建函数迁移清单.md`](docs/05-内建函数迁移清单.md) | 同左 |
| Data model | [`docs/06-数据模型与对象包装.md`](docs/06-数据模型与对象包装.md) | 同左 |
| Configuration & cache | [`docs/07-配置缓存与加载.md`](docs/07-配置缓存与加载.md) | 同左 |
| Format & escape | [`docs/08-格式化与自动转义.md`](docs/08-格式化与自动转义.md) | 同左 |
| Errors | [`docs/09-错误处理与诊断.md`](docs/09-错误处理与诊断.md) | 同左 |
| pyo3 design | [`docs/10-pyo3集成设计.md`](docs/10-pyo3集成设计.md) | 同左 |
| Testing | [`docs/11-测试与验证策略.md`](docs/11-测试与验证策略.md) | 同左 |
| Roadmap | [`docs/12-迁移路线图.md`](docs/12-迁移路线图.md) | 同左 |
| Versioning | [`docs/release/versioning.md`](docs/release/versioning.md) | 同左 |
| Publishing | [`docs/release/publishing.md`](docs/release/publishing.md) | 同左 |
| Security | [`docs/release/security.md`](docs/release/security.md) | 同左 |
| Benchmarks | [`docs/release/benchmarks.md`](docs/release/benchmarks.md) | 同左 |
| Migration ledger | [`docs/测试/迁移测试对照表.md`](docs/测试/迁移测试对照表.md) | 同左 |
| Acceptance report | [`docs/测试/验收报告.md`](docs/测试/验收报告.md) | 同左 |
| Production audit | [`docs/测试/生产就绪审计.md`](docs/测试/生产就绪审计.md) | 同左 |
