...
pub fn lookup(name: &str) -> Option<BuiltinFn> {
    match name {
        ...
        "children" => Some(crate::core::built_ins_for_nodes::children),
        "parent" => Some(crate::core::built_ins_for_nodes::parent),
        "root" => Some(crate::core::built_ins_for_nodes::root),
        "ancestors" => Some(crate::core::built_ins_for_nodes::ancestors),
        "node_name" => Some(crate::core::built_ins_for_nodes::node_name),
        "node_type" => Some(crate::core::built_ins_for_nodes::node_type),
        "node_namespace" => Some(crate::core::built_ins_for_nodes::node_namespace),
        "next_sibling" => Some(crate::core::built_ins_for_nodes::next_sibling),
        "previous_sibling" => Some(crate::core::built_ins_for_nodes::previous_sibling),
        _ => None,
    }
}
